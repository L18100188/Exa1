...
class PrimerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val dButton = view.findViewById<Button>(R.id.btnDolCam)
        val va1 = view.findViewById<EditText>(R.id.entradaDol)
        val va2 = view.findViewById<TextView>(R.id.resd)

        dButton.setOnClickListener{

            val num = va1.text.toString().toDouble()
            val res : Double
            res = num / 18.09

            va2.setText(res.toString())
